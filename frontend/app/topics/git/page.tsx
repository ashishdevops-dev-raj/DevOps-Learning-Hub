...
git config --global alias.last 'log -1 HEAD'`}
        ...
        {/* Right Sidebar - Git Guide */}
        <div className="w-64 flex-shrink-0">
          <div className="sticky top-8">
            <Link href="/topics/git/guide">
              <div className="bg-gradient-to-br from-orange-500 to-red-500 text-white p-4 rounded-lg shadow-lg cursor-pointer hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                <div className="flex items-center gap-2 mb-2">
                  <BookOpen className="w-5 h-5 flex-shrink-0" />
                  <h3 className="text-base font-bold">Git Guide</h3>
                </div>
